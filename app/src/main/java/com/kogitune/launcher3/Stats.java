...
public class Stats {
    ...
    public static final String ACTION_LAUNCH = "com.kogitune.launcher3.action.LAUNCH";
    public static final String PERM_LAUNCH = "com.kogitune.launcher3.permission.RECEIVE_LAUNCH_BROADCASTS";
